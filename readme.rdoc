...
An approximation of how things begin:
    ...
    User-assigned arduino.onload() fires, ready to call arduino.connect()
...
Calls are made via the "arduino" object. Generally, parameters are set and then referenced at initialization/onload().
...
Of course, this is experimental; check arduino.js for the actual code, API and comments.

== About

arduino.js is an experiment by Scott Schiller: http://www.schillmania.com/
